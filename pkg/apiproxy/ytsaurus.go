...
func (c *Ytsaurus) GetUpdateSelector() ytv1.UpdateSelector {
	return c.ytsaurus.Status.UpdateStatus.Selector
}
...
func (c *Ytsaurus) ClearUpdateStatus(ctx context.Context) error {
	...
	c.ytsaurus.Status.UpdateStatus.Selector = ytv1.UpdateSelectorNone
...
func (c *Ytsaurus) SaveUpdatingClusterState(ctx context.Context, strategy ytv1.UpdateSelector, components []string) error {
	logger := log.FromContext(ctx)
	c.ytsaurus.Status.State = ytv1.ClusterStateUpdating
	c.ytsaurus.Status.UpdateStatus.Selector = strategy
