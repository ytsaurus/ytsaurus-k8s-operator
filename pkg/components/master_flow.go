...
var (
	MasterUpdatePossibleCheckStepName            = "UpdatePossibleCheck"
	MasterEnableSafeModeStepName                 = "EnableSafeMode"
	MasterBuildSnapshotsStepName                 = "BuildSnapshots"
	MasterCheckSnapshotsBuiltStepName            = "CheckSnapshotsBuilt"
	MasterStartPrepareMasterExitReadOnlyStepName = "StartPrepareMasterExitReadOnly"
	MasterWaitMasterExitReadOnlyPreparedStepName = "WaitMasterExitReadOnlyPrepared"
	MasterWaitMasterExitsReadOnlyStepName        = "WaitMasterExitsReadOnly"
	MasterDisableSafeModeStepName                = "DisableSafeMode"
)
...
func (m *Master) getUpdateFlow() Step {
	return getStandardUpdateStep(
		...
		[]Step{
			StepCheck{
				StepMeta: StepMeta{
					Name: MasterUpdatePossibleCheckStepName,
			...
			StepRun{
				StepMeta: StepMeta{
					Name:               MasterEnableSafeModeStepName,
			...
			StepRun{
				StepMeta: StepMeta{
					Name:               MasterBuildSnapshotsStepName,
			...
			StepCheck{
				StepMeta: StepMeta{
					Name:               MasterCheckSnapshotsBuiltStepName,
			...
			StepRun{
				StepMeta: StepMeta{
					Name:               MasterStartPrepareMasterExitReadOnlyStepName,
			...
			StepCheck{
				StepMeta: StepMeta{
					Name:               MasterWaitMasterExitReadOnlyPreparedStepName,
			...
			StepCheck{
				StepMeta: StepMeta{
					Name:               MasterWaitMasterExitsReadOnlyStepName,
			...
			StepRun{
				StepMeta: StepMeta{
					Name:               MasterDisableSafeModeStepName,
