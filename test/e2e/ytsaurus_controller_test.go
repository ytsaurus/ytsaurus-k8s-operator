	...
	Context("Update scenarios", Label("update"), func() {
		...
		DescribeTableSubtree("Updating Ytsaurus image", Label("basic"),
			func(oldEpoch, newEpoch string) {
				newVersion := testutil.Images[newEpoch].YtsaurusVersion
			...
			Entry("When update Ytsaurus prev -> test", testutil.YtsaurusPrevEpoch, testutil.YtsaurusTestEpoch),
			Entry("When update Ytsaurus test -> next", testutil.YtsaurusTestEpoch, testutil.YtsaurusNextEpoch),
		)
...
exec "$@"`
		...
		DescribeTableSubtree("With Bus RPC TLS", Label("tls"), func(epoch string) {
			...
			version := testutil.Images[epoch].YtsaurusVersion
			...
			It("Verify that mTLS is active", Label(epoch), Label(version), func(ctx context.Context) {
			...
			Entry("YTsaurus test", testutil.YtsaurusTestEpoch),
			Entry("YTsaurus next", testutil.YtsaurusNextEpoch),
