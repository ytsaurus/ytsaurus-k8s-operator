...
func main() {
	...
	flag.StringVar(&operatorInstance, "watch-operator-instance", os.Getenv("WATCH_OPERATOR_INSTANCE"),
	...
	if operatorInstance != "" {
		managerOptions.LeaderElectionID += "--" + operatorInstance
