...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BindMountSpec) DeepCopyInto(out *BindMountSpec) {
	*out = *in
	if in.ReadOnly != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BindMountSpec.
func (in *BindMountSpec) DeepCopy() *BindMountSpec {
	if in == nil {
		return nil
	}
	out := new(BindMountSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JobEnvironmentSpec) DeepCopyInto(out *JobEnvironmentSpec) {
	*out = *in
	...
	if in.EnvironmentVariables != nil {
		...
		*out = make([]EnvironmentVariableSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
