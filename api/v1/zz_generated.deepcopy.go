...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *YtsaurusValidator) DeepCopyInto(out *YtsaurusValidator) {
	*out = *in
	if in.Ytsaurus != nil {
		in, out := &in.Ytsaurus, &out.Ytsaurus
		*out = new(Ytsaurus)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new YtsaurusValidator.
func (in *YtsaurusValidator) DeepCopy() *YtsaurusValidator {
	if in == nil {
		return nil
	}
	out := new(YtsaurusValidator)
	in.DeepCopyInto(out)
	return out
}
