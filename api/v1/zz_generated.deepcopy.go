...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CookieGeneratorSpec) DeepCopyInto(out *CookieGeneratorSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CookieGeneratorSpec.
func (in *CookieGeneratorSpec) DeepCopy() *CookieGeneratorSpec {
	if in == nil {
		return nil
	}
	out := new(CookieGeneratorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HTTPProxiesSpec) DeepCopyInto(out *HTTPProxiesSpec) {
	*out = *in
	...
	out.CookieGeneratorSpec = in.CookieGeneratorSpec
}
