...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChytControllerSpec) DeepCopyInto(out *ChytControllerSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChytControllerSpec.
func (in *ChytControllerSpec) DeepCopy() *ChytControllerSpec {
	if in == nil {
		return nil
	}
	out := new(ChytControllerSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *YtsaurusSpec) DeepCopyInto(out *YtsaurusSpec) {
	*out = *in
	...
	if in.ChytController != nil {
		in, out := &in.ChytController, &out.ChytController
		*out = new(ChytControllerSpec)
		(*in).DeepCopyInto(*out)
	}
