...
func (in *ClusterFeatures) DeepCopyInto(out *ClusterFeatures) {
	*out = *in
	if in.DefaultPrimaryMedium != nil {
		in, out := &in.DefaultPrimaryMedium, &out.DefaultPrimaryMedium
		*out = new(string)
		**out = **in
	}
}
...
func (in *ExecNodesSpec) DeepCopyInto(out *ExecNodesSpec) {
	*out = *in
	...
	if in.JobHTTPSCertificateSecret != nil {
		in, out := &in.JobHTTPSCertificateSecret, &out.JobHTTPSCertificateSecret
		*out = new(corev1.LocalObjectReference)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MasterCellMaintenanceInfo) DeepCopyInto(out *MasterCellMaintenanceInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MasterCellMaintenanceInfo.
func (in *MasterCellMaintenanceInfo) DeepCopy() *MasterCellMaintenanceInfo {
	if in == nil {
		return nil
	}
	out := new(MasterCellMaintenanceInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TabletNodesSpec) DeepCopyInto(out *TabletNodesSpec) {
	*out = *in
	in.InstanceSpec.DeepCopyInto(&out.InstanceSpec)
	in.ClusterNodesSpec.DeepCopyInto(&out.ClusterNodesSpec)
	if in.TabletCellSlots != nil {
		in, out := &in.TabletCellSlots, &out.TabletCellSlots
		*out = new(int)
		**out = **in
	}
}
...
func (in *TracingSpec) DeepCopyInto(out *TracingSpec) {
	*out = *in
	...
	if in.ProcessTags != nil {
		in, out := &in.ProcessTags, &out.ProcessTags
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *UpdateStatus) DeepCopyInto(out *UpdateStatus) {
	*out = *in
	...
	if in.MasterCellsMaintenance != nil {
		in, out := &in.MasterCellsMaintenance, &out.MasterCellsMaintenance
		*out = make([]MasterCellMaintenanceInfo, len(*in))
		copy(*out, *in)
	}
	if in.TabletCellBundles != nil {
		in, out := &in.TabletCellBundles, &out.TabletCellBundles
