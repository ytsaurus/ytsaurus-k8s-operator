...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MasterCellSpec) DeepCopyInto(out *MasterCellSpec) {
	*out = *in
	if in.HostAddresses != nil {
		in, out := &in.HostAddresses, &out.HostAddresses
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MasterCellSpec.
func (in *MasterCellSpec) DeepCopy() *MasterCellSpec {
	if in == nil {
		return nil
	}
	out := new(MasterCellSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MastersSpec) DeepCopyInto(out *MastersSpec) {
	*out = *in
	in.InstanceSpec.DeepCopyInto(&out.InstanceSpec)
	in.MasterCellSpec.DeepCopyInto(&out.MasterCellSpec)
...
func (in *RemoteYtsaurusSpec) DeepCopyInto(out *RemoteYtsaurusSpec) {
	*out = *in
	...
	if in.SecondaryMasters != nil {
		...
		*out = make([]MasterCellSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
