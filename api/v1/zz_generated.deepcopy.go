...
func (in *MetricsExporter) DeepCopyInto(out *MetricsExporter) {
	*out = *in
	...
	if in.Shards != nil {
		...
		*out = make(map[string]MetricsShard, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsShard) DeepCopyInto(out *MetricsShard) {
	*out = *in
	if in.Filter != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsShard.
func (in *MetricsShard) DeepCopy() *MetricsShard {
	if in == nil {
		return nil
	}
	out := new(MetricsShard)
	in.DeepCopyInto(out)
	return out
}
