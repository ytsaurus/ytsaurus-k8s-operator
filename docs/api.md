...
| `enableImageHeater` _boolean_ | Download required images to all selected nodes before cluster initialization and update.<br />Alternatively component ImageHeater could be enlisted in updatePlan. |  |  |
